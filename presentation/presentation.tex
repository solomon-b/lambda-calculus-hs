...
\begin{frame}[label={sec:org46c19d1}]{Untyped Lambda Calculus}
A formal system for expressing computation using function abstraction,
application, and reduction.
\end{frame}
\begin{frame}[label={sec:org845c00a}]{Syntax}
\begin{itemize}
\item Variables: \(x\)
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org88b917f}]{Reduction}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orge9b1fe3}]{Example Terms}
\begin{itemize}
\item \(id := \lambda x.x\)
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org3a7b589}]{Sample reduction}
\center{Not True} \\
...
\end{frame}
\begin{frame}[label={sec:org374ef36}]{How powerful is this?}
Very powerful. Fully isomorphic to turning machines. 
\end{frame}
\begin{frame}[label={sec:org16efb6c}]{Evaluation Semantics}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org5e7c016}]{Small Step/Big Step}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org6d251bf}]{Untyped Lambda Calculus}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb2a826a}]{Substitution Rules}
\begin{itemize}
\item \([x \mapsto s]x = s\)
\item \([x \mapsto s]y = y\)
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org52776ba}]{Avoiding Name Collisions In Substitution}
\begin{block}{Given Expression:}
\color{red}\((\lambda.x\lambda y. (\lambda x.x)\,y\,x)\, \color{blue}(\lambda y.y\,(\lambda x.x))\)
\end{block}
\end{frame}
\begin{frame}[label={sec:orge33fe6e}]{Avoiding Name Collisions In Substitution}
\begin{block}{Given Expression:}
\color{red}\((\lambda x.\lambda y. (\lambda x.x)\,y\,x)\, \color{blue}(\lambda y.y\,(\lambda x.x))\)
\end{block}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org9b86e4d}]{Avoiding Name Collisions In Substitution}
\begin{block}{Given Expression:}
\color{red}\((\lambda x.\lambda y. (\lambda x.x)\,y\,x)\, \color{blue}(\lambda y.y\,(\lambda x.x))\)
\end{block}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org5bb4124}]{Avoiding Name Collisions In Substitution}
\begin{block}{Given Expression:}
\color{red}\((\lambda x.\lambda y. (\lambda x.x)\,y\,x)\, \color{blue}(\lambda y.y\,(\lambda x.x))\)
\end{block}
\begin{block}{Evaluation Rule:}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org98390b7}]{Avoiding Name Collisions In Substitution}
\begin{block}{How do we perform this substitution without capturing free variables?}
\end{block}
\end{frame}
\begin{frame}[label={sec:org5246cdf}]{Avoiding Name Collisions In Substitution}
\begin{block}{How do we perform this substitution without capturing free variables?}
\end{block}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgfe16727}]{Avoiding Name Collisions In Substitution}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org0698d69},fragile]{A haskell implementation}
...
\end{minted}
\end{frame}
\begin{frame}[label={sec:orgf9c162c}]{Simply Typed Lambda Calculus}
\note{Notes
this is my note}
\begin{columns}
\begin{column}[t]{0.4\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org93add43}]{Simply Typed Lambda Calculus}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org334f46b}]{New Evaluation Rules}
\begin{prooftree}
...
\end{prooftree}
\end{frame}
\begin{frame}[label={sec:org924b93e}]{New Typing Rules}
\begin{prooftree}
\RightLabel{T-NatZ}
\AxiomC{}
\UnaryInfC{$ Z:Nat $}
...
\end{prooftree}
\end{frame}
\begin{frame}[label={sec:org30e7890},fragile]{Implementation: Terms and Types}
 \begin{minted}[,linenos=true, fontsize=\scriptsize]{haskell}
data Term = Var String
...
\end{minted}
\end{frame}
\begin{frame}[label={sec:org7672ae7},fragile]{Implementation: Typechecker}
...
\end{minted}
\end{frame}
\begin{frame}[label={sec:orged9da74},fragile]{Implementation: Evaluator}
 \begin{minted}[,linenos=true, fontsize=\scriptsize]{haskell}
singleEval :: Term -> Maybe Term
singleEval = \case
...
\end{minted}
\end{frame}
\begin{frame}[label={sec:org915232b}]{All Done}
\center
Thank You!
