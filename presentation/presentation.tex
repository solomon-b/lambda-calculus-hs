...
\begin{frame}[label={sec:orgc9b5bf0}]{Untyped Lambda Calculus}
A formal system for expressing computation using function abstraction,
application, and reduction.
\end{frame}
\begin{frame}[label={sec:orgf9c20c0}]{Syntax}
\begin{itemize}
\item Variables: \(x\)
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf4fccda}]{Reduction}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org6556a8e}]{Example Terms}
\begin{itemize}
\item \(id := \lambda x.x\)
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org6ca0a78}]{Sample reduction}
\center{Not True} \\
...
\end{frame}
\begin{frame}[label={sec:org6a24cb8}]{How powerful is this?}
Very powerful. Fully isomorphic to turing machines. 
\end{frame}
\begin{frame}[label={sec:org925ed36}]{Evaluation Semantics}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org5e52625}]{Small Step/Big Step}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgca2d801}]{Untyped Lambda Calculus}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf9f8e42}]{Substitution Rules}
\begin{itemize}
\item \([x \mapsto s]x = s\)
...
(\w.y z w)}
\end{frame}
\begin{frame}[label={sec:org7768d4f}]{Avoiding Name Collisions In Substitution}
\begin{block}{Given Expression:}
\color{red}\((\lambda.x\lambda y. (\lambda x.x)\,y\,x)\, \color{blue}(\lambda y.y\,(\lambda x.x))\)
\end{block}
\end{frame}
\begin{frame}[label={sec:org1ceaeb7}]{Avoiding Name Collisions In Substitution}
\begin{block}{Given Expression:}
\color{red}\((\lambda x.\lambda y. (\lambda x.x)\,y\,x)\, \color{blue}(\lambda y.y\,(\lambda x.x))\)
\end{block}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org280a705}]{Avoiding Name Collisions In Substitution}
\begin{block}{Given Expression:}
\color{red}\((\lambda x.\lambda y. (\lambda x.x)\,y\,x)\, \color{blue}(\lambda y.y\,(\lambda x.x))\)
\end{block}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orge1a2a0d}]{Avoiding Name Collisions In Substitution}
\begin{block}{Given Expression:}
\color{red}\((\lambda x.\lambda y. (\lambda x.x)\,y\,x)\, \color{blue}(\lambda y.y\,(\lambda x.x))\)
\end{block}
\begin{block}{Evaluation Rule:}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org64658fc}]{Avoiding Name Collisions In Substitution}
\begin{block}{How do we perform this substitution without capturing free variables?}
\end{block}
\end{frame}
\begin{frame}[label={sec:orgc3e6c79}]{Avoiding Name Collisions In Substitution}
\begin{block}{How do we perform this substitution without capturing free variables?}
\end{block}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgdd13745}]{Avoiding Name Collisions In Substitution}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgd512317},fragile]{A haskell implementation}
...
\end{minted}
\end{frame}
\begin{frame}[label={sec:orga141fc1}]{Simply Typed Lambda Calculus}
\note{Notes
this is my note}
\begin{columns}
\begin{column}[t]{0.4\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge5aa04d}]{Simply Typed Lambda Calculus}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd79abe9}]{New Evaluation Rules}
\begin{prooftree}
